...
## J'ai oublié les arguments de ma fonction :fearful:

Autocomplétion meilleure dans l'éditeur de script

![](img/completion.gif){fig-align="center" width="90%"}

## J'ai oublié les arguments de ma fonction :fearful:

Un peu plus sobre dans le terminal
...
- Autocompletion **différente** (console _vs_ radian)
